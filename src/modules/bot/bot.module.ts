...
import { ReschedulingFlow } from '@/modules/bot/flows/rescheduling.flow';
...
@Module({
  ...
  providers: [BotService, IntentService, CreateAppointmentFlow, ConfirmingFlow, CancellingFlow, ReschedulingFlow],
